...
Omgekeerd is ook mogelijk. het programmeren in assembler kan namelijk erg tijdrovend zijn.
...
%eens opzoeken hoe dat ik dit mooi in monospace in het verslag krijg.
%\ttfamily{
%script testsmall;\\
%main \{\\
%	var a:= 5;\\
